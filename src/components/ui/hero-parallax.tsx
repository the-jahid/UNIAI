...
<BackgroundLines>
  <div className="flex flex-col lg:flex-row items-center justify-center">
    <div className="relative mx-auto py-20 md:py-40 px-4 w-full lg:w-1/2">
      <h1 className="text-2xl  md:text-4xl lg:text-7xl font-bold text-blue-500 text-center lg:text-left">
        Explore <br /> Meet <br /> Commute
      </h1>
    
      <h4 className="text-blue-500 text-lg md:text-xl lg:text-3xl text-center lg:text-left mt-2">
  ...
  <span className="absolute flex items-center justify-center w-full h-full text-white transition-all duration-300 transform group-hover:translate-x-full ease">Try Out our Beta</span>
